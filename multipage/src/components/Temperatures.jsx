  ...
  return (
    ...
    >
      ...
      <div className="d-flex justify-content-between align-items-center gap-2">
        ...
        <span className="fs-5 fw-bold text-truncate" style={{ maxWidth: "400px", fontSize: "1rem" }}>
          {displayValue}
        </span>
        <button
...
function Temperatures({ name, codename }) {
  ...
  return (
    <div
      ...
      style={{ width: "fit-content", minWidth: "700px" }}
    >
      <div className="text-center fw-bold text-primary mb-3" style={{ fontSize: "1rem" }}>
